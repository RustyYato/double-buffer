...
pub struct HazardFlashStrategy {
...
const _: () = {
    ...
    let _ = send_sync::<HazardFlashStrategy>;
};
...
impl Default for HazardFlashStrategy {
    #[inline]
    fn default() -> Self {
        Self::new()
    }
...
unsafe impl Strategy for HazardFlashStrategy {
